...
(Coxe, 2013, Hastie, 2017), como la Gaussiana, Poisson, Binomial o Gamma. El valor esperado de la respuesta ($\mu$) 
...
permiten la interpretación directa de los coeficientes del modelo (Camilo, 2017, Goetz, 2011).
...
Bernoulli (David, 2000). Sin embargo, la regresión logística puede ser inconsistente en diferentes resoluciones espaciales. 
...
Los GLM se pueden extender a Modelos Lineales Generalizados Jerárquicos (HGLM, por sus siglas en inglés) (Lee, 1996, Lee, 2017), 
...
incluirse en el modelo (Firebaugh, 2013). Los efectos fijos, por otro lado, son los predictores principales de interés en el estudio 
(Torres, 2007).
...
Aunque los HGLM se aplican frecuentemente a datos espaciales, no son necesariamente modelos espaciales (Dong, 2015). 
...
(Dong, 2015). Por lo tanto, las unidades de nivel inferior, se asumen independientes entre sí, incluso cuando son vecinas 
(Rabe, 2008). Así, los HGLM deben tener en cuenta las correlaciones entre los efectos aleatorios ubicados en proximidad geográfica 
cercana (Osland, 2016). De este modo, los efectos aleatorios pueden especificarse como un término aleatorio estructurado 
espacialmente, e interpretarse como los efectos de procesos no observados con estructura espacial (Swanson, 2013). 
...
en cuenta los efectos de las covariables (Austin, 2013). Las variables latentes son no observadas y no pueden medirse directamente, 
pero pueden inferirse a partir de los datos (Aigner, 1984).
